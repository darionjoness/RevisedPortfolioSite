    ...
    <div id='about' className='about'>
        <div className="aboutItems container">
            ...
            <div className="aboutText">
                <h1>About Me</h1>
                <p>Hi, my name is Darion and I'm a 21 year old self taught Front end Developer from Stillwater Oklahoma! I love to code! In my free time when I'm not coding, I like to invest in crypto, watch UFC fights, play basketball, play with my dog named bellah and hangout with my family! I work hard and love to learn!</p>
